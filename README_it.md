...
[English](README.md) • [Italiano](README_it.md) • [Español](README_es.md) • [Français](README_fr.md) • [Deutsch](README_de.md) • [中文](README_zh.md) • [日本語](README_ja.md)
...
Scarica il file `.html` sul tuo dispositivo, successivamente aprilo con il browser.

### 2. Scegli e lancia
Seleziona la scheda (Numeri o Nomi), inserisci i tuoi dati e premi **Estrai**.
